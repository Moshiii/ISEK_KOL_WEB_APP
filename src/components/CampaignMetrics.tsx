  ...
  return (
    <div className="w-full md:w-64 lg:w-72 border-t md:border-t-0 md:border-l border-gray-700 overflow-hidden flex flex-col min-h-0 bg-gray-800">
      <div className="p-4 border-b border-gray-700 flex-shrink-0">
        <h3 className="font-semibold text-lg bg-gradient-to-r from-[#5370FF] to-[#FF66C5] text-transparent bg-clip-text">活动数据</h3>
      </div>
      ...
      <div className="flex-1 p-4 overflow-y-auto custom-scrollbar">
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="gradient-secondary p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-sm text-[#5370FF] font-medium">发文</span>
            </div>
          ...
          <div className="gradient-secondary p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-sm text-[#FF66C5] font-medium">点赞</span>
            </div>
          ...
          <div className="gradient-secondary p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-sm text-[#5370FF] font-medium">回复</span>
            </div>
          ...
          <div className="gradient-secondary p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-sm text-[#FF66C5] font-medium">转发</span>
            </div>
        ...
        <div className="space-y-4">
          <h4 className="font-medium text-gray-200">推特账号</h4>
